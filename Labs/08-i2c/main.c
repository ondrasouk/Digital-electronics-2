...
ISR(TIMER1_OVF_vect)
{
    ...
    static uint8_t addr = 0x5C;           // I2C slave address of sensor
    uint8_t result = 1;                 // ACK result from the bus
    char uart_string[2] = "00"; // String for converting numbers by itoa()
    static uint8_t temp = 0;
    //static uint8_t temp_dec = 0;
    ...
    case STATE_ACK:
        ...
        uart_puts("I2C DHT12 found. Adress: ");
        ...
        uart_puts("I2C DHT12 temperature: ");
        uart_puts(uart_string);
        uart_puts("\n\r");
        state = STATE_IDLE;
        twi_stop();

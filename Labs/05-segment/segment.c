...
uint8_t segment_value[] = {
    ...
    0b00000001,     // Digit 8
    0b00001001,     // Digit 9
    0b00010001,     // Digit A/10
    0b11000001,     // Digit b/11
    0b01100011,     // Digit C/12
    0b10000101,     // Digit d/13
    0b01100001,     // Digit E/14
    0b01110001,     // Digit F/15
    0b11111111,     // Digit blank
    0b00000000,     // Digit all
};
...
/**********************************************************************
 * Function: SEG_clear()
 * Purpose:  Clear segments of the SSD.
 * Returns:  none
 **********************************************************************/
void SEG_clear()
{
    uint8_t pos;
    for(pos = 0; pos < 4; pos++){
        SEG_update_shift_regs(16,pos);
    }
}
/**********************************************************************
 * Function: SEG_clk_2us()
 * Purpose:  Generate clock for SSD at port PD7.
 * Returns:  none
 **********************************************************************/
void SEG_clk_2us()
{
